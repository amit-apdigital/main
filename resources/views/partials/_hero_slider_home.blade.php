<section class="cd-slider-wrapper">
		<ul class="cd-slider">
			<li class="visible">
				<div>
					<video loop muted autoplay preload="auto" poster="/images/hero_background.jpg">
					...
					<a data-link="/tutorials" class="cd-btn learn changePage">Let's launch into learning!</a>
